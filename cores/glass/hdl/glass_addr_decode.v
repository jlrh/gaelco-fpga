...
//
//  Mapa EXACTO de MAME (src/mame/gaelco/gaelco.cpp glass_map):
...
//    FEC000-FEFFFF  work RAM 16KB, COMPARTIDA con el DS5002 (m_shareram).
//                   Glass (a diferencia de squash/thoop/biomtoy) SÍ lleva DS5002 ACTIVO -> esta
//                   region es la unica RAM de trabajo del 68k y es la ventana de la shareram.
//
//  Decodificacion por rango (como el hardware real). Combinacional puro.
// ============================================================================
`default_nettype none

module glass_addr_decode (
    ...
    output wire        cs_blit,     // 700008-700009  BLITTER (comando serie 5 bits) — lo nuevo de glass
    output wire        cs_shram     // FEC000-FEFFFF  work RAM 16KB compartida con DS5002
);
    ...
    // FEC000-FEFFFF (16KB) = work RAM compartida con DS5002 (m_shareram). addr[23:14]==10'h3fb.
    assign cs_shram = as & (addr[23:14] == 10'b1111111011);                             // FEC000-FEFFFF
    ...
    assign cs_blit     = blk_70 & (addr[7:1] == 7'h04);                                 // 700008-700009 (blitter)
