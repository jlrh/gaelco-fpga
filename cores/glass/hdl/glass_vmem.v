// ============================================================================
//  Thunder Hoop (Gaelco) — glass_vmem.v: memorias de la "placa" en BRAM.
//
...
module glass_vmem (
    ...
    input  wire [9:0]  palc_a,          // entrada de paleta BITMAP (puerto C; indices 0..255)
    ...
    reg [7:0] pd_hi[0:1023], pd_lo[0:1023];   // copia vídeo (bitmap, puerto C)
    ...
    // FIX (2026-06-22, = squash): sprite-RAM NO gateada por ce_pix (el motor de sprites corre a ce=1 y lee
    // w0/w2/w3 en ciclos consecutivos; con ce_pix leia dato rancio -> X=Y, color/code basura).
