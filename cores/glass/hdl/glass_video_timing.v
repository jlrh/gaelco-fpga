...
//  para el datapath `glass_video` (que ya está verificado pixel-exacto), las señales
...
module glass_video_timing #(
    ...
    // glass: visarea MAME = 368 ancho (0..367). HTOTAL=512 (hsync 8e6/512=15.625kHz).
    parameter HVIS = 368,
    parameter HFP  = 16,     // front porch
    parameter HSW  = 48,     // sync width
    parameter HBP  = 80,     // back porch   (HTOTAL = 368+16+48+80 = 512 -> hsync 15.625 kHz, CRT OK)
    ...
    // coordenadas visibles para glass_video (válidas cuando de=1)
