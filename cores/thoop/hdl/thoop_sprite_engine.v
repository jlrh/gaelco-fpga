...
//  force_high: si color>=0x38 -> priority=4. gfx 8x8: rom_a = code*8 + row (thoop_gfx_decode is8).
//
...
module thoop_sprite_engine (
    ...
    // El .mra carga c-ROMs CRUDAS -> el blob del sim DEBE venir del romset RAW (no thoop_di).
