...
module wrally2_gae1_video (
    ...
    assign tm_ovr = twin ? (l0_ovr | l1_ovr) : (index ? l1_ovr : l0_ovr);
...
`endif
    ...
    wrally2_gae1_tilemap u_l0 (
        ...
        .lb_x(lb_rx), .lb_q(lb_q0), .wbank(wbank), .rbank(rbank), .ovr(l0_ovr)
    );
    wrally2_gae1_tilemap u_l1 (
        ...
        .lb_x(lb_rx1), .lb_q(lb_q1), .wbank(wbank), .rbank(rbank), .ovr(l1_ovr)
    );
