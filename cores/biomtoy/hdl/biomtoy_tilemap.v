...
//    -1 : registra (tmx,tmy)
//     0 : tile_a = {layer, ty, tx}              (lee el par {data,data2} de biomtoy_vmem)
...
module biomtoy_tilemap (
    ...
    // puerto de lectura de tile de biomtoy_vmem (par {data, data2}), latencia 1 ce
    ...
    // (El sim DEBE descargar el blob desde el romset RAW, no biomtoy_di; si no, doble de-interleave -> glifos.)
