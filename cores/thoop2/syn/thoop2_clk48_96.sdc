# thoop2_clk48_96.sdc — multicycle del cruce clk48<->clk96 + del mc8051 (DS5002).
# Clon del de aligator/WRally (mismo setup CLK48+SDRAM96 + mc8051 cen-paced, instancia u_mcu/u_core
# idéntica). FIX del build V004 que salía a -8.569 ns (mc8051 sin constrainir -> freeze en partida en
# placas con poco margen, reportado por usuarios). Mismo fix que llevó aligator de -7 a +0.26 ns.
