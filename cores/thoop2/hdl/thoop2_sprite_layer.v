...
//
//  Envuelve thoop2_sprite_engine: mientras se MUESTRA la linea N (banco N[0]), RENDERIZA
...
module thoop2_sprite_layer #(
    ...
    output wire [20:0] rom_a,  input wire [7:0] d_p0, d_p1, d_p2, d_p3, input wire gfx_ok,
