...
module wrally_addr_decode (
    ...
    assign cs_vram  = as & (addr[23:20] == 4'h1) & (addr[19:14] == 6'b000000);
    assign cs_pal   = as & (addr[23:20] == 4'h2) & (addr[19:14] == 6'b000000);
    assign cs_spr   = as & (addr[23:16] == 8'h44) & (addr[15:12] == 4'h0);
    assign cs_wram  = as & (addr[23:16] == 8'hFE) & (addr[15:14] == 2'b11);
    ...
    assign cs_dsw      = blk_70 & (addr[7:1] == 7'h00);
    assign cs_p1p2     = blk_70 & (addr[7:1] == 7'h01);
    assign cs_wheel    = blk_70 & (addr[7:1] == 7'h02);
