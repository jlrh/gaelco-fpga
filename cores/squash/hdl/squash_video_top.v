...
module squash_video_top #(
    ...
    reg  [4:0] win_rank_d; reg win_opaque_d;
    always @(posedge clk) begin
        if (rst) begin win_rank_d <= 5'd0; win_opaque_d <= 1'b0; end
        else if (ce_pix) begin win_rank_d <= win_rank; win_opaque_d <= win_opaque; end
    end
