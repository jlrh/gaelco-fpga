// ============================================================================
//  Squash (Gaelco) — Descifrado de VRAM (gaelco_vram_encryption, gaelcrpt.cpp)
//
//  IDENTICO al de WRally (mismo algoritmo gaelcrpt, verificado 1:1 vs gaelcrpt.cpp);
//  SOLO cambian los parametros: Squash usa P1=0x0e, P2=0x4228
...
//  fuera, en squash_main (igual que WRally). bitswap16: 1er indice = bit MSB (15).
// ============================================================================
`default_nettype none

module squash_vram_decrypt #(
    parameter [5:0]  P1 = 6'h0f,
