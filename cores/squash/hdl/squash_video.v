// ============================================================================
//  Squash (Gaelco) — squash_video.v: compositor de los 2 tilemaps (Tipo-1).
//
//  Instancia 2 squash_tilemap (L0, L1) con scroll aplicado y resuelve la PRIORIDAD
