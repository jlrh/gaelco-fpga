// ============================================================================
//  Squash (Gaelco) — CAPA de sprites en tiempo real (doble buffer ping-pong).
//
//  Envuelve squash_sprite_engine: mientras se MUESTRA la linea N (banco N[0]), RENDERIZA
