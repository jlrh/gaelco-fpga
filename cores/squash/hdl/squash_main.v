...
module squash_main (
    ...
    assign vmem_dec_wdata = dec_word;
...
`ifdef SIMULATION
    ...
    always @(posedge clk) begin
        if (prog_addr==19'h00C62) hit_18c4 <= 1'b1;
        if (prog_addr==19'h00CEA) hit_19d4 <= 1'b1;
        if (prog_addr==19'h00CFE) hit_19fc <= 1'b1;
    end
    ...
    always @(posedge clk) begin
        if (prog_addr==19'h002B0) hit_560 <= 1'b1;
        if (prog_addr==19'h002B1) hit_562 <= 1'b1;
        if (prog_addr==19'h002C7) hit_58e <= 1'b1;
